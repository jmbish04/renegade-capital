...
/**
 * Validates the health of the PodcastAgent by attempting to resolve its DO binding.
...
export async function checkHealth(env: Env) {
  try {
    ...
    const agent = getAgentByName(env.PODCAST_AGENT, "health-probe");
    ...
    return {
      name: "PodcastAgent Durable Object",
