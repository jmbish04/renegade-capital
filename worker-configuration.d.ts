/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6aa026c288d65b08a3173b307c65e640)
// Runtime types generated with workerd@1.20260507.1 2026-05-04 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/_worker");
		durableNamespaces: "PolicyAgent" | "PodcastAgent" | "InvestorAgent";
	}
	interface Env {
		SESSION: KVNamespace;
		R2_TRUMP_POLICY: R2Bucket;
		DB: D1Database;
		...
		AI_MODEL_CHAT: "@cf/openai/gpt-oss-120b";
		AI_MODEL_EMBEDDINGS: "@cf/baai/bge-large-en-v1.5";
		AI_MODEL_RERANKING: "@cf/baai/bge-reranker-base";
		INTRO_VIDEO_URL: "https://renegade-capital-files.hacolby.app/media/IntroPodcastExplainer.mp4";
		POLICY_AGENT: DurableObjectNamespace<import("./src/_worker").PolicyAgent>;
		PODCAST_AGENT: DurableObjectNamespace<import("./src/_worker").PodcastAgent>;
		INVESTOR_AGENT: DurableObjectNamespace<import("./src/_worker").InvestorAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "AI_MODEL_CHAT" | "AI_MODEL_EMBEDDINGS" | "AI_MODEL_RERANKING" | "INTRO_VIDEO_URL">> {}
}
